...
ax[0].set_title('Duneheight vs Wind direction North')
ax[0].scatter(north, duneheight1, label='north')
ax[1].set_title('Duneheight vs Wind direction East')
ax[1].scatter(east, duneheight1, label='east')
ax[2].set_title('Duneheight vs Wind direction South')
ax[2].scatter(south, duneheight1, label='south')
ax[3].set_title('Duneheight vs Wind direction West')
ax[3].scatter(west, duneheight1, label='west')
ax[4].set_title('Duneheight vs Wind direction Northeast')
ax[4].scatter(northeast, duneheight1, label='northeast')
ax[5].set_title('Duneheight vs Wind direction Southeast')
ax[5].scatter(southeast, duneheight1, label='southeast')
ax[6].set_title('Duneheight vs Wind direction Southwest')
ax[6].scatter(southwest, duneheight1, label='southwest')
ax[7].set_title('Duneheight vs Wind direction Northwest')
...
ax[0].set_title('Duneheight vs High humidity')
ax[0].scatter(highhumidity, duneheight1, label='high humidity')
ax[0].set_title('Duneheight vs Low humidity')
ax[1].scatter(lowhumidity, duneheight1, label='low humidity')
ax[0].set_title('Duneheight vs Average humidity')
ax[2].scatter(avghumidity, duneheight1, label='avg humidity')

# Precipitation
fig, ax = plt.subplots(2)
ax[0].set_title('Duneheight vs Precipitation')
ax[0].scatter(precipitation, duneheight1, label='duneheight')
plt.legend()
