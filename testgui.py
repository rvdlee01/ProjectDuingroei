...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        select = PhotoImage(file='download.png')
        ...
        self.button2 = tk.Button(self, image=select,
                            command=lambda: getCsvFile(self), font = myFont, borderwidth = 0)
        self.button2.image = select
